...
import { Tweet as TweetApi, getTweet } from "react-tweet/api";
import {
  EmbeddedTweet,
  TweetNotFound,
  TweetSkeleton,
...
async function getAndCacheTweet(id: string): Promise<TweetApi | undefined> {
  ...
  const cachedTweet: TweetApi | null = await redis.get(`tweet:${id}`);
