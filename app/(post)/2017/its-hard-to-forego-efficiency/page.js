...
export default function Efficiency() {
  return (
    ...
    >
      ...
      <P>
        Spending some time optimizing a certain function takes your focus and
        time away from optimizing another.
      </P>

      <P>
        We all want everything to work perfectly, look beautiful, be intuitive
      ...
      <P>
        The problem is: You can’t spend all of your time and resources
        optimizing everything at once. Any extra minute you dedicate to an
        activity takes it away from something else.
      </P>
      ...
      <P>
        For a basic example, consider a task you repeat every single day:
        Googling things. Imagine you switch to a new web browser that makes
        rendering search results take 200 milliseconds instead of, previously,
        20 milliseconds.
      </P>

      <P>
        It would be almost impossible to justify such a{" "}
        <em>backwards change</em> in your daily routine.
      </P>
      ...
      <P>
        ...
        grass is out there does the same. If at your current job deploying an
        app to production takes hours, but you know of a colleague of yours that{" "}
      ...
      <P>
        It only took me one or two visits to know that I’d be willing to spend
        all that effort and go through all the bureaucratic trouble.
      </P>

      <P>
        Every time I’d go back to my home country, I wasn’t my <em>same</em>{" "}
        productive self. Every single process felt painfully slow. Getting a
        bank account. Incorporating a company. Ordering food. Hiring a plumber.
        The work the plumber does. How the plumber got paid. The plumber wasn’t
        on time. Oh god.
      </P>
      ...
      <Quote>
        ...
        country, in matters of technics and organization. Objects of everyday
        ...
        evoked the marvelous development of technical devices and methods of
        work.
      </Quote>

      <P>
        It’s hard to part ways with a more efficient web browser, imagine how
        hard it is to leave behind a more efficient country!
      </P>

      <P>
        If there is a quality worth fighting to preserve, this one is at the top
        of my list. As well as welcoming those who so keenly appreciate it and
        are eager to make their contribution.
      </P>
    </Post>
  );
}
