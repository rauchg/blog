...
<Image 
  caption="Analysis of the HTML sent by the server for every page of a SPA in the wild"
  src="/images/7-principles-of-rich-web-applications/kpfLbf6dha.png"
/>
...
<Image caption="How many KB a server can send for each phase of the connection by segments"
  src="/images/7-principles-of-rich-web-applications/WI9kN_9iyR.png" />
...
caption="Proof-of-concept SPA with inlined CSS and JS that doesn’t incur in extra roundtrips"
src="/images/7-principles-of-rich-web-applications/NeV5qFDaVR.png" />
...
<Image
caption="Google adapts its layout as soon as you hold down a key"
src="/images/7-principles-of-rich-web-applications/CmkksKRbrl.gif" />
...
<Image caption="iPhone OS enforced loading default.png before the application"
src="/images/7-principles-of-rich-web-applications/Gg1AwDA71S.png" />
...
<Image
caption="The image gets rendered and fades in before the upload completes"
src="/images/7-principles-of-rich-web-applications/iCig_gr__M.gif" />
...
<Image caption="A single-user application can still benefit from reactivity" src="/images/7-principles-of-rich-web-applications/15MbLjLsfm.gif" />
...
<Image caption="Each page reacts to the session and login state" src="/images/7-principles-of-rich-web-applications/FS74zJHpDg.gif" />
...
<Image caption="Example of what would occur if we disregard elapsed time upon reconnection" src="/images/7-principles-of-rich-web-applications/D7obeKaOlB.png" />
...
<Image
caption="Possibly the most annoying artifact of the old web"
src="/images/7-principles-of-rich-web-applications/mc3PlaztUS.png" />
...
<Image caption="The beforeunload browser warning" src="/images/7-principles-of-rich-web-applications/8Eu4Sk9mD8.png" />
...
<Image caption="Pressing back incorrectly loads the initial HTML from the pageload" src="/images/7-principles-of-rich-web-applications/c081WZaE8H.gif" />
...
<Image caption="Infinite pagination is usually susceptible to scrolling amnesia" src="/images/7-principles-of-rich-web-applications/3m0DOKp9BW.gif" />
...
<Image
caption="The toggling of comments should be preserved when navigating history"
src="/images/7-principles-of-rich-web-applications/bvqcnxO0De.gif" />
...
<Image 
caption="jQuery plugin that predicts the mouse trajectory"
src="/images/7-principles-of-rich-web-applications/VZ7GRJR3Rl.gif" />
