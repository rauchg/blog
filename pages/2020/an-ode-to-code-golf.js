...
export default function AnOdeToCodeGolf() {
  return (
    ...
    >
      ...
      <P>
        And now, I&apos;m slightly embarrassed to admit that I&apos;ve probably
        given 10 different answers to the same question.
      </P>
      <P>
        The main reason is that there wasn&apos;t a particular instant, or
        month, or year, or flow state I got in where I finally learned to code.
        It was more of a <em>discontinuous</em> process full of ups, downs,
        impostor syndrome, months of voracious learning, followed by{" "}
        <a
      ...
      <P>
        However, looking back, there were many decisive contributing factors
        that clearly helped: exposure to open-source (Linux), being involved in
        online communities (IRC and forums) and <b>hacking competitions</b>.
      </P>
      <H2 id="izhal">Izhal: the hacker&apos;s ladder of success</H2>
      <P>
        One day, on one of the forums I frequented, someone shared an online
        game called &quot;Izhal.com&quot;, which I became completely obsessed
        about. It was similar in spirit as another game called
        &quot;Slyfx.com&quot;, which one{" "}
        <a
          target="_blank"
      ...
      <P>
        The idea was simple: you start with a simple hacking challenge at Level
        1, and your goal is to hack the made-up system you are given to progress
        onto the subsequent levels. There was a forum associated with it, where
        you could meet others and get hints. The level you were in was your
        flair, and there was a public leaderboard of everyone who was playing.
      </P>
      <P>
        Izhal&apos;s step 1&apos;s URL was, if I remember correctly, something
        like <Code>http://izhal.com/welcome/1.html</Code> and it said
        &quot;Welcome to the tournament&quot;. The solution to get to level 2
        involved inspecting the source of the page and finding a HTML comment
        like:
      </P>
      ...
      <P>
        ...
        went from easy (viewing the HTML source) to harder (disassembling
        binaries and writing{" "}
      ...
      <P>
        Why did I decide to write about Izhal? Yesterday I was catching up with
        my friend{" "}
      ...
      <P>
        ...
        a yearly &quot;code golf&quot; tournament, which is a game with the goal
        of reducing the amount of code as much as possible
        (&quot;golfing&quot;). In this case, the constraint was to make the{" "}
      ...
      <P>
        This article is about learning to code, and I definitely wouldn&apos;t
        start with JS1k. If you are getting started, JS1k is good for setting up
        the aspirations of what you could do one day, or to marvel at the
        expressive power of JS. Here&apos;s{" "}
      ...
      <Demo />
      <P>
        Since JS1k is not returning for 2020, Román shared his new hobby with
        me:{" "}
      ...
      <P>
        As I played around with it, the first thing that stood out to me was
        that results were being <b>remotely verified</b>. The game was sound and
      ...
      <P>
        ...
        familiar, a Quine is a computer program that prints its own source. One
        of my favorite examples is{" "}
        <a
      ...
      <P>
        ...
        mechanism worked, I decided to give it a try. In other words, I wanted
        to understand how the authors of code-golf.io had ensured you
        couldn&apos;t do evil things to their system.
      </P>
      <P>
        The first question I had in my mind was: &quot;What is this system
        executing?&quot;. Is it invoking a function? Who is invoking it? How?
      </P>
      <P>
      ...
      >
        <Image
          alt="The challenge naturally failed because when the code runs, it doesn't print itself"
          src="/images/an-ode-to-code-golf/golf1.png"
        />
      </Figure>
      ...
      <P>
        ...
        . I wasn&apos;t able to get <Code>console.log</Code> to work either, so
        I re-used my previous inspection mechanism: <Code>throw</Code>.
      </P>
      ...
      >
        <Image
          alt="We know that throw exists and it's a valid, hacky way to print"
          src="/images/an-ode-to-code-golf/golf2.png"
        />
      </Figure>
      ...
      <P>
        ...
        , and the first member I enumerated was called <Code>print</Code>.
        Eureka! That sounds really useful.
      </P>

      <P>
        At this point, I suddenly found myself again in 2002. I felt that
        familiar feeling Izhal gave me back in the day, of challenging myself to{" "}
      ...
      <Callout emoji="💡">
        Spoiler alert: I&apos;m detailing the solution to one of the code
        challenges
      </Callout>
      ...
      >
        <Image
          alt="Enumerating the global object reveals all the methods we can use"
          src="/images/an-ode-to-code-golf/golf3.png"
        />
      </Figure>
      ...
      <P>
        The tricky thing about writing a Quine is that it requires that you
        think recursively. The temptation might be to say: I&apos;ll just write
      ...
      >
        <Image
          alt="An impossible approach to get a quine"
          src="/images/an-ode-to-code-golf/golf4.png"
        />
      </Figure>

      <P>
        Notice that code-golf.io was expecting{" "}
        <Code>write(&apos;write()&apos;))</Code> but we just gave it{" "}
        <Code>write()</Code>. No matter what we write in that string, we&apos;ll
        always be one layer removed from success. We&apos;ll{" "}
        <a
      ...
      <P>
        ...
        familiar method: <Code>read</Code>. That sounds like it could read a
        file!
      </P>
      ...
      <Figure width={1594} height={708} desc="An early taste of success">
        <Image
          alt="An early taste of success"
          src="/images/an-ode-to-code-golf/golf5.png"
        />
      </Figure>

      <P>
        The program executes, reads its own code, and prints it back. The
        awesome verification system of code-golf.io compared input and output,
        and granted my…
      </P>

      <P>
        😫 Completely unsatisfactory, partial, deflating, half-baked
        &quot;victory&quot;.
      </P>
      ...
      >
        <Image
          alt="My enemies, but also the benchmark to inspire and show what's possible"
          src="/images/an-ode-to-code-golf/golf6.png"
        />
      </Figure>
      ...
      <P>
        My initial reaction was: how could I possibly make that shorter?
        That&apos;s nuts! There&apos;s absolutely nothing non-essential about
        it.
      </P>

      <P>
        I abandoned the &quot;read the filesystem&quot; approach altogether, and
        went off on a disappointing tangent:
      </P>
      ...
      >
        <Image
          alt="An alternative path with a lot more characters"
          src="/images/an-ode-to-code-golf/golf7.png"
        />
      </Figure>
      ...
      <P>
        Because I had already tried to compress the code a lot (as you can see,
        it looks quite unintelligible) and the gap between my new approach and
        the old one was a huge 3 characters, and I needed an extra 3 to match
        primo&apos;s <b>24</b>, I abandoned this direction.
      </P>
      ...
      >
        <Image
          alt="The members of os look very familiar"
          src="/images/an-ode-to-code-golf/golf8.png"
        />
      </Figure>
      ...
      <P>
        ...
        , so I gave <Code>chdir</Code> a try, so that I could change the
        directory I was in, and I brought back the relative approach:
      </P>
      ...
      >
        <Image
          alt="Learning more about the code-golf.io filesystem"
          src="/images/an-ode-to-code-golf/golf9.png"
        />
      </Figure>

      <P>
        Even though I was now at a disheartening <b>39</b> chars, it offered the
        understanding that I was inside a regular Unix-like filesystem. I set
        out to try to understand what was the default working directory of the
        system. Was it{" "}
        <Code>
      ...
      >
        <Image
          alt="A monumental single-character discovery"
          src="/images/an-ode-to-code-golf/golf10.png"
        />
      </Figure>
