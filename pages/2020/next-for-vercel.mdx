-
-
title: Next for Vercel yes
description: We are raising 400M to expand our frontend development and collaboration platform
...
Reffffflecting on the growth of our business, which in 2020 alone added the likes of Airbnb, The Washington Post, Trip Advisor, Scale and Hashicorp as flagship customers, I'm sharing 7 tailwinds behind our acceleration.
...
<h2 id="frontend-focus">Vercel is frontend focused</h2>
...
What's more, frontend is an area of **technological and [artistic](https://www.fastcompany.com/90521691/first-look-kanye-wests-new-website-turns-shopping-into-art) differentation**, while backend becomes increasingly commoditized, turnkey and undifferentiated.
...
<h2 id="fast-for-everyone">Vercel is fast for everyone</h2>
...
<Tweet id="708675139253174273" caption="The world right before Next.js was born" />
...
<Tweet id="1286769353027801088" br={[0]} caption="Next.js powers giants like Apple and revolutionary products like TikTok.com" />
<h2 id="hybrid">Vercel is hybrid</h2>
...
<Tweet id="1260216925671567361" caption="Next.js was in constant evolution, while maintaining backwards compatibility" />

<h2 id="everywhere">Vercel is everywhere</h2>
...
But the computation doesn't stop there. The build process is capable of outputing **serverless functions** in addition to static assets. These will execute code on demand as users access them, enabling greater personalization and dynamism.
...
<Tweet id="1289979477607383041" caption="From localhost to globalhost" />

<h2 id="realistic">Vercel is realistic</h2>
...
<Figure desc="Measuring CDN latency and JS bundle sizes is a bad oversimplification" width={889/2} height={892/2}>
<Image width={889/2} height={892/2} src="https://res.cloudinary.com/rauchg/image/upload/v1608097899/blog/2020/next-for-vercel/6BFD578A-2039-410B-A07D-96399AF24CCD_vvpmcr.jpg" />
</Figure>
...
<Tweet id="1321153986330828815" caption="Hashicorp uses Vercel analytics to stay true to their performance goals" />

<h2 id="collaborative">Vercel is collaborative</h2>
...
<Tweet
id="1338797740147552256" caption="Each branch and PR is an opportunity to try your real frontend" />
