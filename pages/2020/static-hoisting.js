...
export default function StaticHoisting() {
  return (
    <Post
      id="static-hoisting"
    ...
    >
      <P>
        ...
        <Link href="/2020/2019-in-review" legacyBehavior>2019 in Review</Link>, detailing the
        industry trend towards{" "}
        <Link href="/2020/2019-in-review#static-is-the-new-dynamic" legacyBehavior>
          static hosting
        </Link>{" "}
        and the rise of Jamstack CDNs like{" "}
        <Link href="/2020/vercel" legacyBehavior>Vercel</Link>, a question has persistently
        come up:{" "}
        <a
      ...
      <P>
        The answer boils down to our ability to not just <b>host</b> static
        assets and cache them, but also <b>hoist</b> them.
      </P>
      ...
      <P>
        ...
        to the &quot;top&quot; of a scope, which makes the following code
        actually work:
      </P>
  ...
  function b() {
    return "hello world"
      ...
      <P>
        ...
        to describe a class of optimization where the code is analyzed, and
        parts that look{" "}
        <b>
          &quot;static&quot; or invariant are moved (<em>hoisted</em>) outside
          of loops.
        </b>
      </P>
...
`}
      ...
      <P>
        Notice that the sum <Code>b + c</Code> has nothing to do with the
        context of the loop: it&apos;s{" "}
        <a
      ...
      <P>
        Hoisting computation within a program is great, and odds are the
        compilers and VMs you use every day have plenty of optimizations like
        it.
      </P>
      ...
      <P>
        ...
        that would have happened later on, in the request&apos;s timeline, has
        now been shifted to the build phase, performed once and made available
      ...
      <P>
        ...
        , the next build process has started automatically outputting the
        optimal asset on a per-page (entrypoint) basis. Futher, with{" "}
        <a
      ...
      <P>
        Next.js makes hoisting the static parts of your site or app to the edge
        a breeze. Let&apos;s look at the build output of a complex site (
...
●  (SSG)     automatically generated as static HTML + JSON (uses getStaticProps)`}</Snippet>
      ...
      <P>
        As you can see from the symbols (○ ● λ), which represent the output
        types:
      </P>

      <UL>
        <LI>
          We build the homepage statically. Our company&apos;s homepage, our
          &quot;cover letter&quot;, gets built as <Code>index.html</Code> and
          pushed to the edge for maximum speed and reliability.
        </LI>
      ...
      <P>
        ...
        hosts. However, for the longest time, CDNs have been treating the
        &quot;origin&quot; as an opaque black box.
      </P>

      <P>
        It&apos;s now possible, instead, to push content directly{" "}
        <b>to the network</b> and design frameworks that optimize for this
        capability. As a result, with optimizations like{" "}
        <b>static asset hoisting</b>, websites are now becoming faster and more
