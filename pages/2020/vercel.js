  ...
  return (
    ...
    >
      ...
      <P>
        ...
        ultimate workflow for developing, previewing, and shipping Jamstack
        sites.
      </P>
      <P>
        ...
        split from the backend so that site development can happen ever faster
        and independent of the backend. Jamstack is an architecture shift that’s
        been proven out by Google, Facebook, and Microsoft (
        <a
          target="_blank"
        ...
        ) - and is quickly becoming the new modernization push for everyone
        else.
      </P>
      ...
      <P>
        ...
        architecture and the general push to modernize the frontend with tools
        for faster iteration (delighting Javascript developers) and faster sites
      ...
      <P>
        ...
        introduced this primitive of the component. Other frameworks allow you
        to define components, but the movement that really pioneered this trend
        was React.
      </P>
      ...
      <P>
        ...
        and I co-created Next.js because of our belief that React was so
        powerful it could become the full engine for the frontend. We started
        Next.js to provide some critical new functionality to make React
        consumable for everyone who wanted to do <b>everything</b> with React,
        instead of just one specific component. We saw a demand for the
        component-based React approach to drive the full frontend experience.
      </P>
      ...
      <P>
        ...
        entire frontend experience. Vercel aims to be their one-stop shop
        &mdash; not just if they arrived at that point by using{" "}
      ...
      <P>
        The code push and review workflow is way too complicated. Too many
        cycles are spent configuring your own CI/CD pipeline, setting up
        Jenkins, finding your optimal vendor for CI, finding your optimal vendor
        for CDN, and so on. It’s also hard to get your CI/CD and your CDN to
        talk, and ensuring the Rube Goldberg apparatus stays coherent.
      </P>
      ...
      <P>
        ...
        workflow for deploying / reviewing code in real-time &mdash; similar to
        a preview in a CMS, but we accomplish this by{" "}
      ...
      <P>
        Sounds like a pretty basic evolution, but it tears down so much
        complexity and makes frontend teams so much faster!
      </P>

      <P>
        The most obvious immediate benefit of the URL for deploy review is
        making it much easier to collaborate across any organization, from
        marketing and sales to legal and engineering. Frontend teams can send
        these URLs over chat, instantly seeing what their teammates are
        developing and what the next big push will be.
      </P>

      <P>
        When you have a deploy URL, it redefines not just testing, but the
        entire software development experience, from idea to conception to QA.
        Now you’re testing against the real thing. You get a working URL that
        can be shared and tested as a full working version. You eliminate the
        entire staging process.
      </P>

      <P>
        Another benefit of Vercel’s deploy preview URL is that you get to test
        your program and site with all the bells and whistles required to run
        the site. Vercel gives you automatic SSL support &mdash; every one of
        your deploy URLs is https. We’ve already done the infrastructure heavy
        lifting to give you a secure environment empowered by{" "}
      ...
      <P>
        If you’re creating a modern frontend nothing matters more than great
        site performance for the user.{" "}
        <a
      ...
      <P>
        ...
        deploy. You don’t have to think about what’s going on with our CDN or
        the serverless magic behind the scenes &mdash; your URL gets deployed to
        every edge in the world, all your static assets get cached, compressed
        with the greatest codecs (like{" "}
        <a
        ...
        frontend performance metric you could care about but couldn’t test on
        your local computer.
      </P>
