...
export default withViews(({ views }) => (
  <Post>
    ...
    <P>Spending some time optimizing a certain function takes your
      focus and time away from optimizing another.</P>

    <P>We all want everything to work perfectly, look beautiful, be
      intuitive and perform really well.</P>

    <P>This is true for your life as it is true for engineering.</P>

    <P>You want inbox zero, a healthy mind and body, up to date software
      development skills, design ability, a happy team, a happy family,
      an impressive bookshelf, a great social life…</P>

    <P>The problem is: You can’t spend all of your time and resources
    ...
    <P>When you start coding a new app, you might not document your APIs, thoroughly comment your code or write lots of tests.</P>

    <P>You basically learn to be ok with foregoing. But here’s a thing that I’m absolutely convinced you can’t forego: efficiency.</P>
    ...
    <P>As an immigrant to the United States, I had to spend tireless hours putting together the required evidence and paperwork to become a legal resident.</P>

    <P>It only took me one or two visits to know that I’d be willing to spend all that effort and go through all the bureaucratic trouble.</P>

    <P>Every time I’d go back to my home country, I wasn’t my <em>same</em> productive self. Every single process felt painfully slow. Getting a bank account. Incorporating a company. Ordering food. Hiring a plumber. The work the plumber does. How the plumber got paid. The plumber wasn’t on time. Oh god.</P>

    <P>In <a href="https://www.amazon.com/World-As-I-See/dp/1494877066">The World As I see it</a>, Einstein shared his impressions of America, selecting this as his
    favorite trait:</P>

    <Quote>What first strikes the visitor with amazement is the superiority of this country, in matters of technics and organization. Objects of everyday use are more solid than in Europe, houses infinitely more convenient in arrangement. Everything is designed to save human labour. Labour is expensive, because the country is sparsely inhabited in comparison with its natural resources. The high price of labour was the stimulus which evoked the marvelous development of technical devices and methods of work.</Quote>

    <P>It’s hard to part ways with a more efficient web browser, imagine how hard it is to leave behind a more efficient country!</P>

    <P>If there is a quality worth fighting to preserve, this one is at the top of my list. As well as welcoming those who so keenly appreciate it and are eager
    to make their contribution.</P>
