...
export default function InReview2016() {
  return (
    <Post id="2016-in-review" title="2016 in Review" date="January 6, 2017">
      ...
      <P>
        Our mission is to empower the individual. At home or inside companies
        and teams. Go directly to production without barriers.
      </P>
      ...
      <P>
        We take the <Code>package.json</Code>, <Code>Dockerfile</Code>, or
        static files, build them in the cloud and serve them securely and
        scalably under HTTP/2.
      </P>

      <P>
        Each deployment is <b>immutable</b> and has its own unique URL. They
        look like this: <Code>https://rauchg-blog-hhafwnefgw.now.sh/</Code>.
        This model has a lot of benefits that are not immediately obvious.
      </P>

      <P>
        One is that the same system gives you development, staging and
        production all in one. You can deploy to build, test and iterate during
        development. You can <em>stage</em> by simply sharing these links to
        your co-workers or clients, before you make them live.
      </P>

      <P>
        To go to production, you just <em>alias</em> them. With one command,
        obviously:{" "}
        <Code>now alias rauchg-blog-hhafwnefgw.now.sh rauchg.com</Code> is what
        I ran for you to be reading these words now. Zero-downtime.
      </P>
      ...
      <P>
        It&apos;s tedious for the individual but it&apos;s also tedious for
        teams. I&apos;ve been in too many companies where you depend on a
        specific <em>person or team</em> to manage this stuff.
      </P>
      ...
      <P>
        ...
        check if it&apos;s using our nameservers. If it is, we configure the
        records automatically.
      </P>

      <P>
        Like I said above, we want to make cloud deployment <b>global</b>. A
        cloud where you choose regions is not living up to its name.
      </P>
      ...
      <P>
        ...
        . Unlike most apps and websites, it&apos;s hard for these programs to
        bloat. They tend to do one thing well. They compose. They are easy to
        replace.
      </P>
      ...
      <P>
        ...
        . Text is low-bandwidth. Text is fast to input. Text is searchable. If
        you use{" "}
        <a
      ...
      >
        <Image
          alt="Showing off Hyper's simple UI, config and plugin installation"
          src="/images/2016-in-review/hyperapp.gif"
        />
      </Figure>

      <P>
        Since it&apos;s built on Electron, we&apos;re able to render URLs as
        sandboxed <Code>&lt;webview&gt;</Code> tags. For some people, this could
        develop into an interesting{" "}
      ...
      <P>
        It brings back some of the good ideas that came with writing PHP sites:
        no setup, start with the filesystem, automatic routing, you get
        pre-rendered HTML in the first hop instead of a blank page.
      </P>

      <P>
        You start by writing a <Code>./pages/index.js</Code> that exports a
        function (stateless component) or a <Code>class</Code> that inherits
        from <Code>React.Component</Code>:
      </P>
...
`}</Snippet>
      ...
      <P>
        Each <em>&quot;page&quot;</em> is a webpack entry-point. Each section of
        your application thus becomes its own <em>bundle</em> of code based on
        its <Code>import</Code> statements. No need to ship several megabytes of
        JS code with each page anymore.
      </P>
      ...
      <P>
        ...
        <em>lazily</em>. Apps tend to download <em>everything</em> in advance,
        and therefore tend to feel faster afterwards.
      </P>
      ...
      <P>
        Many of us have already marveled at Tesla&apos;s tremendous foresight
      ...
      <Quote>
        Not only this, but through television and telephony we shall see and
      ...
      <P>
        But there&apos;s more. Inside that paper I found a wonderful analogy
        that I&apos;ve kept coming back to when thinking about modern human
        societies:
      </P>
      ...
      <Quote>
        ...
        commenter&apos;s fresh insight with previous results could lead to a
        solution. He submitted his paper less than two weeks later and included
        an acknowledgement thanking the commenter, Uwe Stroinski, a maths
        instructor in Reutlingen, Germany.
      </Quote>
      ...
      <P>
        From this perspective, the role and importance of any given individual
        is clearly diminished. Nothing but a cog in a giant unpredictable
        machine, which Nick Szabo appropriately dubs a{" "}
        <a
      ...
      <Quote>
        Computers and humans will continue to co-evolve with computers making
        the faster progress but falling far short of apocalyptic predictions of
        &quot;Singularity,&quot;{" "}
        <b>
          except to the extent that much of civilization is already a rolling
          singularity. For example people can&apos;t generally predict
          what&apos;s going to happen next in markets or which new startups will
      ...
      <P>
        Finally, if we accept this analogy, we can&apos;t underestimate the
        impact that fast, free, UI-less (imagine global unlimited LTE) and
        unrestricted internet will have in our world. Exciting times are ahead
        of us.
      </P>
      ...
      <P>
        ...
        <em>no trusted third-party</em>, it follows that the system must be
        backed by a <em>universally verifiable</em> reality.
      </P>

      <P>
        That&apos;s what the anchoring to physical energy expenditure provides,
        in the form of electricity used for solving{" "}
        <a href="https://en.wikipedia.org/wiki/Hashcash" target="_blank">
          Hashcash
        </a>{" "}
        puzzles.
      </P>
      ...
      <P>
        ...
        , and follow very basic rules and efficient verifications to arrive to
        the universal view of the database.
      </P>
      ...
      <P>
        Investing in the security of the network until now required subscribing
        to this philosophy, to a large extent. But another incentive that I
        hadn&apos;t previously contemplated was elucidated by a fascinating
        interview to Chandler Guo, a Chinese miner.
      </P>
      ...
      <P>
        The combination of the above ideas might bring to fruition the vision
        held by the likes of Henry Ford and Thomas Edison of the{" "}
        <b>energy dollar</b>:
      </P>
      ...
      >
        <Image
          alt="New York Times story from February 20, 1922"
          src="/images/2016-in-review/ePCBk5ZmYM.png"
        />
      </Figure>
      ...
      <P>
        The argument is very convincing. The demo of the app she&apos;s working
        on seems taken straight out of a{" "}
      ...
      <P>
        I&apos;m philosophically inclined to think that we should take joy in
        the unknown, in the relativity of it all, in our ability to access{" "}
        <b>nothing but a shadow of the truth</b>, as Terence McKenna puts it:
      </P>

      <Quote>
        It&apos;s amazing to me, I mean, if you were to meet a termite who
        stated that his or her goal in life was the perfect modeling of the
        cosmos. You would think it was quite a funny undertaking, and yet how
        different are we that we should presume more than a shadow of the truth?
      </Quote>
      ...
      <Quote by="Rupert Sheldrake">
        ...
        messiness in our explanation of what&apos;s going on. Nowhere is it
        written that human minds should be able to give a full accounting of
        creation in all dimensions and on all levels.{" "}
        <b>
          Ludwig Wittgenstein had the idea that philosophy should be what he
          called &quot;true enough.&quot; I think that&apos;s a great idea. True
          enough is as true as can be gotten
        </b>
        . The imagination is chaos. New forms are fetched out of it. The
        creative act is to let down the net of human imagination into the ocean
        of chaos on which we are suspended and then to attempt to bring out of
        it ideas.
      </Quote>
      ...
      <P>
        I came across a fascinating new take on the idea of consciousness and
        the evolutionary origin of perception by means of natural selection by
        Donald Hoffman:
      </P>
      ...
      <P>
        An amusing example is given of an Australian Beetle attempts to mate
        with a beer bottle because it satisfied its primitive heuristics. It had
        to be brown, translucent and large. Oops.
      </P>
      ...
      >
        <Image
          alt='"I could have sworn it was a beetle"'
          src="/images/2016-in-review/i2q5apnEho.jpg"
        />
      </Figure>

      <P>
        Notice that I used the word <em>hack</em> to describe these adaptations
        to the environment. I actually took that from the presentation itself.
      </P>

      <P>
        Despite Hoffman&apos;s specialty being the cognitive sciences, the
      ...
      <P>
        From this lens, even the study of physics, while useful, might not get
        us closer to understanding reality. Inspecting a button on a screen and
        finding pixels doesn&apos;t tell us much about how the GPU and CPU work.
        And the same would be true for confirming the existence of the{" "}
      ...
      <P>
        What we normally call reality is just the <b>interface to reality</b>{" "}
      ...
      <Quote by="David Deutsch">
        ...
        thought,’ as Feynman once put it, ‘that he understood paper.’ But he was
        mistaken. Real, quantum-mechanical paper is wildly different from the
        abstract stuff that the Turing machine uses. The Turing machine is
      ...
      <P>
        Inspired by React&apos;s excellent warnings, I decided that every time I
        write an error out to a terminal or console, I&apos;ll attach a URL to
        it.
      </P>
      ...
      >
        <Image
          alt="Thoughtcomplete: autocomplete for your thoughts"
          src="/images/2016-in-review/thoughtcomplete.gif"
        />
      </Figure>
      ...
      <P>
        ...
        , Borges draws a beautiful comparison between the vastness of the
        Universe and an imaginary Library.
      </P>
      ...
      <Quote>
        ...
        Library, thousands and thousands of false catalogues, the demonstration
      ...
      <P>
        ...
        observations or even puns (many of which I suspect are
      ...
      <P>
        Needless to say, the suggestions it makes can be pretty amusing. I
        promise it will take you to places you didn&apos;t think you&apos;d go
        to. Twitter&apos;s{" "}
        <a
      ...
      >
        <Image
          alt="Need a module to compare versions? How about all the possible ones?"
          src="/images/2016-in-review/mVLV4CAcnm.jpg"
        />
      </Figure>
      ...
      <P>
        I created a hashing scheme for our customers&apos; unique IDs that
        yields beautiful gradients, demonstrated here by typing in my emails:
      </P>
      ...
      <P>
        The technique involves hashing the UID, obtaining a number and
        calculating its <Code>mod 360</Code> (which is the highest value for the
        HUE in the{" "}
      ...
      <P>
        I though they&apos;d be an annoying gimmick (specially for work), but
        they turned out to be quite the opposite.
      </P>
      <P>
        Emojis are one of the best tools for conveying nuance and emotion over
        this medium. Reactions allow for them to flow more naturally and are
        shown inline without creating clutter.
      </P>
      ...
      <P>
        Yes, I don&apos;t use semicolons anymore. I&apos;m very glad to not
        spend any time at all coordinating or even debating code styling
        decisions!
      </P>
      ...
      <FootNotes>
        <Note id="1">
          If there&apos;s a way to{" "}
          <a
            href="https://en.wikipedia.org/wiki/Hedge_(finance)"
            target="_blank"
          >
            <em>hedge</em>
          </a>{" "}
          the risky personal investment of launching a startup company, it
          surely must be to do it with people you love and respect.
        </Note>
