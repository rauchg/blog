...
export default withViews(({ views }) => (
  <Post>
    ...
    <P>
      少し前の頃まで、コンポーネント化は常識ではありませんでした。セレクタエンジンやDOMが話題の中心だったのです。そんな中、Facebookが生み出したReactがコンポーネント化の概念を提唱しました。もちろん、他のフレームワークでもコンポーネントを定義することはできましたが、コンポーネント化の流れを作った先駆者は紛れもなくReactでした。
    </P>
    <P>
      数年前、
