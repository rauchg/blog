...
So: the hardware of the Internet can currently achieve within a factor of two of the speed of light.`}</Snippet>
    ...
    <Figure
      width={934}
      height={754}
      desc="Analysis of the HTML sent by the server for every page of a SPA in the wild"
    >
    ...
    <Figure
      width={901}
      height={409}
      desc="How many KB a server can send for each phase of the connection by segments"
    >
    ...
    <Figure
      width={1153}
      height={899}
      desc="Proof-of-concept SPA with inlined CSS and JS that doesn’t incur in extra roundtrips"
    >
    ...
    <Figure
      width={1015}
      height={625}
      desc="Google adapts its layout as soon as you hold down a key"
    >
    ...
    <Figure
      width={324}
      height={463}
      desc="iPhone OS enforced loading default.png before the application"
    >
    ...
    <Figure
      width={931}
      height={602}
      desc="The image gets rendered and fades in before the upload completes"
    >
    ...
    <Figure
      width={661}
      height={578}
      desc="A single-user application can still benefit from reactivity"
    >
    ...
    <Figure
      width={818}
      height={547}
      desc="Each page reacts to the session and login state"
    >
    ...
    <Figure
      width={1024}
      height={640}
      desc="Example of what would occur if we disregard elapsed time upon reconnection"
    >
    ...
    <Figure
      width={374}
      height={165}
      desc="Possibly the most annoying artifact of the old web"
    >
    ...
    <Figure
      width={1022}
      height={642}
      desc="Pressing back incorrectly loads the initial HTML from the pageload"
    >
    ...
    <Figure
      width={782}
      height={551}
      desc="Infinite pagination is usually susceptible to scrolling amnesia"
    >
    ...
    <Figure
      width={797}
      height={563}
      desc="The toggling of comments should be preserved when navigating history"
    >
    ...
    <Figure
      width={540}
      height={480}
      desc="jQuery plugin that predicts the mouse trajectory"
    >
