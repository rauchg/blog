...
export default function ES6() {
  return (
    <Post id="ecmascript-6" title="ECMAScript 6" date="February 22, 2015">
      ...
      <P>
        For the past few months I’ve been exclusively writing ECMAScript 6 code
        by taking advantage of transpilation
      ...
      <P>
        ...
        ES6 has been able to adopt a lot of CoffeeScript’s great innovations in
        a non-disruptive way, to such an extent that some have even questioned
        its{" "}
...
I call that a victory for making things and trying them out.
      ...
      <P>
        This further strengthens the <b>interoperability</b> between the
        different contexts in which JavaScript can be executed.
      </P>
  ...
  // …
      ...
      <P>
        With the caveat, of course, that it introduces a single fixed global
        name that other parts of the code will have to refer to. And from the
      ...
      <P>
        With this situation in mind, Node.JS led the way with the introduction
        of the <Code>require</Code> runtime function and the{" "}
      ...
      <P>
        A common scenario to illustrate this is the generation of browser
        bundles of modules, with tools like{" "}
        ...
        . These can only be conceived because they treat <Code>require()</Code>{" "}
        as syntax, effectively ridding it of its inherent dynamism.
      </P>
      ...
      <P>
        In other words, the simplest (and arguably most desirable) form of
        module definition requires the extra default keyword. Or in the absence
        of that, the usage of <Code>{"{ }"}</Code> when importing.
      </P>

      <H2 id="destructuring">Destructuring</H2>

      <P>
        One of the most common patterns that has emerged in modern JavaScript
        code is the usage of option objects.
      </P>
  ...
  body: JSON.stringify({
    ...
    last: ‘Rauch’
      ...
      <P>
        ...
        calling fetch would be an exercise in argument order memorization and
        the typing of the <Code>null</Code> keyword.
      </P>
...
function fetch(url, opts){
  // …
      ...
      <P>
        Usually followed by the manual assignment of defaults to local
        variables:
      </P>
...
var method = opts.method || 'GET'`}</Snippet>
      ...
      <P>
        ...
        practice actually introduces subtle bugs. In this case we’re not
        admitting that <Code>opts.body</Code> could be 0, so robust code would
...
`}</Snippet>
  ...
  console.log(method)
      ...
      <P>
        ...
        <Code>with</Code>, without the magic or negative performance
        implications.
      </P>
...
// \`i\` doesn't exist here.`}</Snippet>
      ...
      <P>
        With the lack of <Code>sprintf</Code> or similar utilities in the
        standard JavaScript library, composing strings has always been more
...
\``}</Snippet>
      ...
      <P>
        ...
        inner-workings, the barrier to entry to newcomers was unnecessarily
        high.
      </P>
  ...
  set prop(){}
      ...
      <P>
        The so-called “fat arrow” functions are <em>lexically bound</em>.
        Consider the example of a method within a class that launches two
        timers:
      </P>
  ...
  timers(){
    ...
    setTimeout(() => {
      ...
      <P>
        ...
        <Code>function</Code>) will log <Code>&quot;undefined&quot;</Code>. The
        second one will now correctly log name.
      </P>

      <H2 id="async-io">First-class support for async I/O</H2>

      <P>
        Asynchronous code execution has been around for almost the entire
        history of the language. <Code>setTimeout</Code>, after all, was
        introduced around the time JavaScript 1.0 came out.
      </P>
      ...
      <P>
        ...
        absence of an error (and not <Code>undefined</Code> or{" "}
        <Code>false</Code>
      ...
      <P>
        ...
        have emerged to enable transpiling and polyfilling, and browsers have
        over time added proper debugging and error reporting support for them
        (through source maps).
      </P>
  ...
  return await user.save()
      ...
      <FootNotes>
        <Note id="1">
          ...
          its popularity to refer to JavaScript source-to-source compilation.
          That aside, the merits of the term are{" "}
