...
export default function PureUI() {
  return (
    <Post id="pure-ui" title="Pure UI" date="July 13, 2015">
      ...
      <P>
        The process involved, among other things, creating a new UI, ditching
        the dependency on Flash in favor of HTML5 <Code>&lt;video&gt;</Code> and
      ...
      <P>
        In the short term, as I’ll show, the communication between the
        programmer and designer will improve dramatically by becoming well
        technically delineated.
      </P>

      <P>
        And if I’m allowed to extrapolate, a clear path is now laid out towards
        a future where the steps to go from sketch to design to implementation
        are greatly more accessible to everyone with an idea.
      </P>
      ...
      <P>
        ...
        <Ref id="1" /> it enables and its implications to the design and
        creation workflow.
      </P>
      ...
      <P>
        ...
        <Code>concat(&apos;hello&apos;, &apos;world&apos;)</Code> can be
        substituted with <Code>&apos;hello world&apos;</Code> without changing
  ...
  if (src) {
    ...
    return div('No video to load');
      ...
      <P>
        ...
        get a <Code>&lt;div&gt;No video to load&lt;/div&gt;</Code> back. If I
        call it with <Code>&apos;Charlie bit mey&apos;</Code> and{" "}
        <Code>&apos;charlie.mp4&apos;</Code> I&apos;ll likewise get the titlebar
        and video I expect.
      </P>

      <P>
        Since I’m not returning the actual DOM elements (no{" "}
        <Code>document.createElement</Code>) or performing any real rendering,
        we can think of this function as one that performs mappings between an
        input (my parameters) and an output (the virtual dom).
      </P>
      ...
      <P>
        With this model in place, the programmer is thus relieved from the
        burden of specifying the transition between states (or transformation)
        of the UI over time. No need to specify how to go from <b>A</b> to{" "}
        <b>B</b>: just describe what <b>A</b> looks like and what <b>B</b> looks
      ...
      <P>
        UI designers have been intuitively “programming” in this way for some
        time now, arguably in a more direct way.
      </P>

      <P>
        While design specifications were usually drawn out on a single canvas,
        the rise of mobile has forced the industry to think about varying screen
      ...
      <Figure width={1194} height={1350} wide>
        <Image
          alt="Typical presentation of a design handout"
          src="/images/pure-ui/JDDxCgEoBj.png"
        />
      </Figure>
  ...
  if (width > 375) {
    ...
    return div('Twitter', abbreviate(num));
      ...
      <Figure width={1298} height={520} wide>
        <Image
          alt="Design systems in action"
          src="/images/pure-ui/AgHrso5cqp.png"
        />
      </Figure>
      ...
      <P>
        ...
        <Code>class=&quot;btn-sm&quot;</Code> or <Code>disabled</Code>. The
        button produces different outputs depending on the supplied parameters,
        which can be combined:{" "}
        <Code>&lt;button class=&quot;btn-sm btn-outline&quot;&gt;</Code>,{" "}
        <Code>&lt;button disabled class=&quot;btn-outline&quot;&gt;</Code>, and
        so on.
      </P>
      ...
      <P>
        With this paradigm in mind, I set out to realize the different main
        states of the video player with my design tool.
      </P>

      <Figure width={719} height={960} wide>
        <Image
          alt="Multiple states of the video player"
          src="/images/pure-ui/iIIdwqx6y4.png"
        />
      </Figure>
      ...
      <P>
        ...
        wrongly reduced to “just <Code>&lt;video&gt;</Code> and a few extra
        divs”.
      </P>

      <P>
        Through this lens, one can hazard an explanation for the age-old problem
        of poor software development estimates. When the <em>magnitude</em> of
        the undertaking is not clear for the developer or designer, let alone
        for the people removed from the creation process, it’s simply impossible
        to make any accurate predictions.
      </P>

      <P>
        Unlike other projects I’d worked on in the past, the next step of the
        implementation almost perfectly matched the design workflow. I broke
        down the initial design into even smaller functions that would be
        rendered into HTML artboards.
      </P>

      <P>
        Since these functions are essentially acting as mappings between data
        and UI, I created a simple JSON file that would describe the different
  ...
  "views": [
    [
      ...
      <P>
        In many cases, it’s necessary to go back to the design tool and
        represent these new states adequately. For the tips, I had to split the
        triangle in half if they approach the boundaries of the player. I added
        a state to display when the image grid is not loaded yet. And so on. The
        tooltip alone expanded into the 6 representations seen above.
      </P>

      <HR />

      <P>
        This allows us to make a distinction of two very distinct (yet
        frequently interleaved) phases of the creation process: <b>design</b>{" "}
        and <b>discovery</b>.
      </P>

      <P>
        Design is the process of taking the available data and coming up with
        its representation. The outcome is reasonably well specified and
        understood.
      </P>
      ...
      <P>
        Even the most careful designer that can anticipate -due to their
        extensive experience and ability- a wide range of scenarios will
        necessarily participate in this feedback loop.
      </P>
      ...
      <P>
        ...
        the video is converting, I intended to show a blurred out thumbnail with
        a progress bar that notifies the user in realtime.
      </P>
      ...
      <P>
        Once rendered, I incorporated a <Code>[+]</Code> icon (which you can
        click above) to modify the parameters with which the view was invoked
        and rendered.
      </P>
      ...
      <P>
        In this case, clicking and dragging the numbers to alter the dimensions
        of the player allows us to see how it would perform in the real world
        beyond just the breakpoints specified by the designer, like iPhone or
        iPad size.
      </P>
      ...
      <Figure width={465} height={407}>
        <Image
          alt="Exploring the design"
          src="/images/pure-ui/KK_maFpl8V.gif"
        />
      </Figure>
      ...
      <P>
        ...
        TODO list expands, but in a way that neatly breaks down
        responsibilities.
      </P>

      <P>
        This workflow brings us closer to understanding the <b>completeness</b>{" "}
        of implementation in a very direct way. If you think up and hand out 20
...
 }`}</Snippet>
      ...
      <P>
        ...
        In a simple case like this, the task would be to ensure that both
        logical branches (failure and success) are executed.
      </P>
      ...
      <P>
        ...
        provide answers to questions like “what if this network call is taking
        too long?”, “what if it the response doesn’t come back?” and “what if
        the server returns an error?”, among others.
      </P>

      <P>
        In addition, getting to the particular payment form in this example
        could be the result of more branching. You must first be logged in,
        maybe under a certain type of user, of a certain role and specific
        privileges, with some pre-existing data in their profile.
      </P>
      ...
      <P>
        Mapping out your application in this way can not only allow you to
        measure progress but also complexity. Are there too many steps? Too many
        screens? Are they consistent?
      </P>
      ...
      <P>
        ...
        improperly scoped or understood, and it can explain why it’s taking
        longer to ship.
      </P>
      ...
      <FootNotes>
        <Note id="1">
          In general, comparing libraries or frameworks in terms of features
          seems inferior to examining the model it imposes on the programmer.
          The latter will inform you about how well the code will fare over time
          as the product matures and the team grows, but the former won’t. It
          will also empower you to foresee what the evolutionary path of the
          technology looks like.
        </Note>
        <Note id="2">
          Artboards were initially introduced by Illustrator as a way of
          grouping related designs together, such as a{" "}
